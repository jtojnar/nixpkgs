...
in stdenv.mkDerivation rec {
  ...
  # Some scripts used by tests need to use interpreters that are available
  # in Flatpak runtime. Others have their hash checked by flatpak-builder.
  dontPatchShebangs = true;

  postFixup = ''
    # Scripts run directly by installed tests (.test files)
